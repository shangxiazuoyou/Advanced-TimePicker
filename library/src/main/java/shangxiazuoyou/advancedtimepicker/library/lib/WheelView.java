package shangxiazuoyou.advancedtimepicker.library.lib;
...
import shangxiazuoyou.advancedtimepicker.library.R;
import shangxiazuoyou.advancedtimepicker.library.adapter.WheelAdapter;
import shangxiazuoyou.advancedtimepicker.library.listener.OnItemSelectedListener;
...
public class WheelView extends View {
    ...
    public WheelView(Context context, AttributeSet attrs) {
        ...
        textSize = getResources().getDimensionPixelSize(R.dimen.picker_textsize);
        customTextSize = getResources().getBoolean(R.bool.picker_customTextSize);
        if (attrs != null) {
            ...
            textColorOut = a.getColor(R.styleable.picker_picker_textColorOut, textColorOut);
            textColorCenter = a.getColor(R.styleable.picker_picker_textColorCenter, textColorCenter);
            dividerColor = a.getColor(R.styleable.picker_picker_dividerColor, dividerColor);
            textSize = a.getDimensionPixelOffset(R.styleable.picker_picker_textSize, textSize);
        }
